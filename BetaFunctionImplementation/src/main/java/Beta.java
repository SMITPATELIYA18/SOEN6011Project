...
public final class Beta {
     ...
     */
    double calculateGammaStirling(final double value) {
     ...
     * @return The result of the Gamma function.
     */
    double calculateGammaFactorial(final double value) {
     ...
     */
    double calculateBetaStirling(final double p, final double q, final double r) {
        double valueOfGammaForP = calculateGammaStirling(p);
        double valueOfGammaForQ = calculateGammaStirling(q);
        double valueOfGammaForR = calculateGammaStirling(r);
     ...
     * @return The result of the Beta Function.
     */
    double calculateBetaFactorial(final double p, final double q, final double r) {
        double valueOfGammaForP = calculateGammaFactorial(p);
//        System.out.println(valueOfGammaForP);
        double valueOfGammaForQ = calculateGammaFactorial(q);
        double valueOfGammaForR = calculateGammaFactorial(r);
        return (valueOfGammaForP * valueOfGammaForQ) / valueOfGammaForR;
    }
